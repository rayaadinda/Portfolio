...
export default function Header() {
	...
	return (
        ...
        sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-fill dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
				...
				>
					{links.map((link) => (
						...
						>
							<Link
								className={clsx(
									"flex w-full items-centerjustify-center px-3 py-3 hover:text-gray-950 transition",
									{
