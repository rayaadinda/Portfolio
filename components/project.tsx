...
<motion.div
 ...
 >
    ...
    sm:pr-8 sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 relative hover:bg-gray-200 transition group-even:even:pl-8">
        ...
        <Image src={imageUrl} alt="Project" quality={95} className="absolute top-8 -right-40
