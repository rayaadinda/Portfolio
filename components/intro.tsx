...
export default function Intro() {
  ...
  return (
    <section id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
      <span className="font-bold">Hello, I'm Raya Adinda.</span> undergraduate student{" "}
        <span className="font-bold">at Universitas Pamulang</span> I enjoy
      ...
      >
        ...
        >
          Contact me here <BsArrowRight className=" opacity-70 group-hover:translate-x-1 transation" />{" "}
        </Link>

        <a className="group bg-white text-black px-7 py-3 flex items-center
        ...
        active:scale-105 transition cursor-pointer border border-black/10"
        href="https://www.linkedin.com/in/raya-adinda/" target="_blank">
          <BsLinkedin  />
        </a>
        ...
        active:scale-105 transition cursor-pointer border border-black/10"
        href="https://github.com/rayaadinda" target="_blank">
          <FaGithubSquare  />
        </a>
      </motion.div>
    </section>
